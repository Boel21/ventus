...
/******/ (() => {
  ...
  (() => {
    ...
    var src = __webpack_require__(8138); // CONCATENATED MODULE: external "gsap"
    const external_gsap_namespaceObject = gsap; // CONCATENATED MODULE: external "LocomotiveScroll"
    const external_LocomotiveScroll_namespaceObject = LocomotiveScroll;
    var external_LocomotiveScroll_default = /*#__PURE__*/ __webpack_require__.n(
      external_LocomotiveScroll_namespaceObject
        ...
        if (breakpointTablet.matches) {
          ...
          return (() => {
            videoElements.forEach((video) => {
              ...
              video.poster = posterT ? posterT : posterM;
              video.src = srcT ? srcT : srcM;
            });
          })();
...
*/
    ...
    var external_jQuery_default = /*#__PURE__*/ __webpack_require__.n(
      external_jQuery_namespaceObject
    ...
    function setSelectBox() {
      ...
      function selectBoxHandler(e) {
        if (e.target.id != "country" && e.target.id != "lang") {
          ...
          $targetDropBox.style.height = isOpen
            ? 0
    ...
    function commonPopup() {
      ...
      const $selectBtns = document.querySelectorAll(
        ".popup_base.pop_select .pop_select_btn"
      );
      $selectBtns.forEach((el) => {
        el.addEventListener("click", function (e) {
          ...
          document.getElementById(
            el.closest(".pop_con").dataset.value
    ...
    function openPop(popup) {
      const targetElem =
        typeof popup === "string" ? document.getElementById(popup) : popup;
    ...
    var body_scroll_lock = __webpack_require__(5036); // CONCATENATED MODULE: ./src/etc.clientlibs/hankooktire/clientlibs/clientlib-base/js/common.js
    // [TODO] jquery 로드 분리
    ...
    const common = function (callback) {
      ...
      window.addEventListener("load", function () {
        if (document.querySelector("[data-scroll-container]")) {
          ...
          if (window.CustomEvent && typeof window.CustomEvent === "function") {
            var event = new CustomEvent("compFuncRun", {
              detail: { some: "data" },
            });
          } else {
            var event = document.createEvent("CustomEvent");
          ...
          const locomotiveScrollUpdate = new ResizeObserver(() =>
            window.locomotive.update()
          );
          locomotiveScrollUpdate.observe(
    ...
    /* harmony default export */ const js_common = common; // CONCATENATED MODULE: ./src/etc.clientlibs/hankooktire/clientlibs/clientlib-local/js/gnb.js
    ...
    /* harmony default export */ const gnb = function gnb() {
      ...
      if (menuD1.length > 0) {
        ...
        document
          .querySelector(".sidenav .btn--close")
          .addEventListener("click", function (e) {
            $sideNav.classList.remove("show");
    ...
    /* harmony default export */ const tire_finder = (function tireFinder() {
      ...
      if ($searchPanel) {
        document
          .querySelector("#util-find-tire")
          .addEventListener("click", function (e) {
            $searchPanel.classList.remove("hide");

            window.disableBodyScroll(
              $searchPanel.querySelector(".search-content")
            );

            if (
              !!document.querySelector(".ltdn.type-b") &&
              window.innerWidth < 1024 &&
              document.querySelector(".ltdn.type-b").matches(".fixed")
            ) {
              document
                .querySelector(".ltdn.type-b")
                .classList.add("dimmed-fix");
            }
            e.preventDefault();
            e.stopPropagation();
          });
        ...
        const $searchTabBtns = document.querySelectorAll(
          ".search-tab > button"
        );
    ...
    function setWindow() {
      ...
      function resizeHandler() {
        const assistantHeight = document.querySelector(".assistant")
          ? document.querySelector(".assistant").clientHeight
          : 0;
    ...
    function HeaderScroll() {
      ...
      const $assistantMenuOpener = document.querySelector(
      ...
      if ($assistantMenuOpener) {
        $assistantMenuOpener.addEventListener("click", (e) => {
          if (document.querySelector(".sidenav").classList.contains("show"))
            return;
        ...
        document
          .querySelector(".assistant__menu-closer")
