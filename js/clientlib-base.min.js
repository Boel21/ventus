...
(function () {
  ...
  function Tabs(config) {
    ...
    function init(config) {
      ...
      var deepLinkItemIdx =
        CQ.CoreComponents.container.utils.getDeepLinkItemIdx(that, "tab");
  ...
  function Image(config) {
    ...
    function init(config) {
      ...
      if (
        ...
        var url =
          decodeURIComponent(config.options.src).split(
        ...
        request.onload = function () {
          if (request.status >= 200 && request.status < 400) {
            ...
            if (
              ...
              payload.set.relation.length > 0
            ) {
              for (var i = 0; i < payload.set.relation.length; i++) {
                smartCrops[
                  parseInt(payload.set.relation[i].userdata.SmartCropWidth)
      ...
      that._elements.container = that._elements.link
        ? that._elements.link
        : that._elements.self;
    ...
    function loadImage() {
      ...
      if (Object.keys(smartCrops).length > 0) {
        ...
        replacement = hasWidths
          ? (that._properties.dmimage ? "" : ".") +
            getOptimalWidth(that._properties.widths)
          : "";
      }
      var url = that._properties.src.replace(
        SRC_URI_TEMPLATE_WIDTH_VAR,
        replacement
      );
      ...
      if (imgSrcAttribute === null || imgSrcAttribute === EMPTY_PIXEL) {
        ...
        var urlTemplateParts = that._properties.src.split(
          SRC_URI_TEMPLATE_WIDTH_VAR
        );
        // check if image src was dynamically swapped meanwhile (e.g. by Target)
        var isImageRefSame = imgSrcAttribute.startsWith(urlTemplateParts[0]);
        if (isImageRefSame && urlTemplateParts.length > 1) {
          isImageRefSame = imgSrcAttribute.endsWith(
            urlTemplateParts[urlTemplateParts.length - 1]
          );
        }
        if (isImageRefSame) {
          that._elements.image.setAttribute("src", url);
    ...
    function unwrapNoScript() {
      ...
      that._elements.container.insertBefore(
        imageElement,
        that._elements.noscript
      );
      ...
      if (that._elements.container.matches(selectors.image)) {
        ...
        that._elements.image = that._elements.container.querySelector(
          selectors.image
        );
      }

      that._elements.map = that._elements.container.querySelector(
        selectors.map
      );
      that._elements.areas = that._elements.container.querySelectorAll(
        selectors.area
      );
    }
    ...
    function isLazyVisible() {
      ...
      return (
        eb >= wt - that._properties.lazythreshold &&
        et <= wb + that._properties.lazythreshold
      );
    }
...
function setCookie(name, value, exp) {
  const date = new Date();
  date.setTime(date.getTime() + exp * 30 * 24 * 60 * 60 * 1000); // 24*60*60*1000 ì¼
...
function gotoLocalsite(target, dtlPage) {
  ...
  if (userCountry == "US") {
    ...
    resultSite =
      "https://www.hankooktire.com/global/en/hankook-in-your-location.html";
  ...
  $.ajax({
    ...
    success: function (data) {
      if (data.resultCode == "0000") {
        ...
        if (userCountry == "US") {
          resultSite =
            "https://www.hankooktire.com/us/en/tirelist/vehicle/electric-vehicle.html";
        } else if (userCountry == "CA") {
          resultSite =
            "https://www.hankooktire.com/ca/en/tirelist/vehicle/electric-vehicle.html";
        } else if (userCountry == "KR") {
          resultSite =
            "https://www.hankooktire.com/kr/ko/tirelist/vehicle/electric-vehicle.html";
          ...
          resultSite =
            "https://www.hankooktire.com/uk/en/tirelist/vehicle/electric-vehicle.html";
        } else if (userCountry == "RO") {
          resultSite =
            "https://www.hankooktire.com/ro/ro/tirelist/vehicle/electric-vehicle.html";
        } else if (userCountry == "IT") {
          resultSite =
            "https://www.hankooktire.com/it/it/tirelist/vehicle/electric-vehicle.html";
        } else if (userCountry == "SE") {
          resultSite =
            "https://www.hankooktire.com/se/sv/tirelist/vehicle/electric-vehicle.html";
        } else if (userCountry == "AU") {
          resultSite =
            "https://www.hankooktire.com/au/en/tirelist/vehicle/electric-vehicle.html";
        } else if (userCountry == "ES") {
          resultSite =
            "https://www.hankooktire.com/es/es/tirelist/vehicle/electric-vehicle.html";
        } else if (userCountry == "FR") {
          resultSite =
            "https://www.hankooktire.com/fr/fr/tirelist/vehicle/electric-vehicle.html";
        } else if (userCountry == "NL") {
          resultSite =
            "https://www.hankooktire.com/nl/nl/tirelist/vehicle/electric_vehicle.html";
        } else if (userCountry == "HU") {
          resultSite =
            "https://www.hankooktire.com/hu/hu/tirelist/vehicle/electric_vehicle.html";
        } else if (userCountry == "CN") {
          resultSite =
            "https://www.hankooktire.com/cn/zh/tirelist/vehicle/electric-vehicle.html";
        } else if (userCountry == "CZ") {
          resultSite =
            "https://www.hankooktire.com/cz/cs/tirelist/vehicle/electric-vehicle.html";
        } else if (userCountry == "PL") {
          resultSite =
            "https://www.hankooktire.com/pl/pl/tirelist/vehicle/electric_vehicle.html";
        } else if (userCountry == "TR") {
          resultSite =
            "https://www.hankooktire.com/tr/tr/tirelist/vehicle/electric_vehicle.html";
          //}else if(userCountry == "ID"){
          //}else if(userCountry == "JP"){
          //}else if(userCountry == "TH"){
        } else if (userCountry == "MY") {
          resultSite =
            "https://www.hankooktire.com/tr/tr/tirelist/vehicle/electric-vehicle.html";
          ...
          resultSite =
            "https://www.hankooktire.com/ru/ru/tirelist/vehicle/electric-vehicle.html";
        } else {
    ...
    success: function (data) {
      if (data.resultCode == "0000") {
        ...
        if (isCheck && checkPage(resultSite)) {
          if (target.toLocaleLowerCase() == "_self") {
            window.location.href = resultSite.replace(
              "/content/hankooktire/",
              "/"
            );
          } else {
          ...
          if (pathname.split("/")[2] == "en") {
            ...
            if (brands == "ventus") {
              goUrl =
                "https://www.hankooktire.com/kr/ko/tirelist/brand-family/ventus.html";
            } else if (brands == "dynapro") {
              goUrl =
                "https://www.hankooktire.com/kr/ko/tirelist/brand-family/dynapro.html";
            } else if (brands == "kinergy") {
              goUrl =
                "https://www.hankooktire.com/kr/ko/tirelist/brand-family/kinergy.html";
            } else if (brands == "smart") {
              goUrl =
                "https://www.hankooktire.com/kr/ko/tirelist/brand-family/smart.html";
            } else if (brands == "winterIcept") {
              goUrl =
                "https://www.hankooktire.com/kr/ko/tirelist/brand-family/winter-i-cept.html";
            } else if (brands == "winterIpike") {
              goUrl =
                "https://www.hankooktire.com/kr/ko/tirelist/brand-family/winter-i-pike.html";
            }
          }
